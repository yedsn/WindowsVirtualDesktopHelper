...
namespace WindowsVirtualDesktopHelper {
	internal static class Localizer {
		private static readonly Dictionary<string, string> Chinese = new Dictionary<string, string> {
			...
			{ "Restore", "恢复" }, { "Update", "更新" }, { "Add", "新增" }, { "Copy", "复制" }, { "View Details", "查看详情" }, { "Edit Window Rules", "编辑窗口规则" }, { "Rename", "重命名" }, { "Delete", "删除" },
			{ "Rule Snapshots", "规则快照" }, { "Automatic snapshots", "定时自动快照" }, { "minutes", "分钟" }, { "Keep automatic snapshots", "自动快照最多保留" }, { "Captured", "捕获时间" }, { "Type", "类型" }, { "Cleanup rules", "清理规则" }, { "Lock rules", "锁定规则" }, { "Capture Snapshot", "拍摄快照" }, { "Restore Rules", "恢复规则" }, { "Manual", "手动" }, { "Automatic", "自动" }, { "Legacy", "旧版" }, { "Current", "当前" },
			{ "No rule snapshots saved.", "尚未保存规则快照。" }, { "Automatic snapshot settings saved.", "自动快照设置已保存。" }, { "Capture Rule Snapshot", "拍摄规则快照" }, { "Could not save the rule snapshot.", "无法保存规则快照。" }, { "Restore this snapshot's desktop rules and lock rules? Open windows will not be moved. Use Apply Desktop Rules afterwards to rearrange windows.", "恢复此快照的桌面规则和锁定规则？不会移动打开的窗口。需要重新排列窗口时，请随后使用“应用桌面规则”。" }, { "This legacy snapshot does not include lock rules. Current lock rules will be kept.", "此旧版快照不包含锁定规则，将保留当前锁定规则。" }, { "Rules restored. No windows were moved.", "规则已恢复，没有移动任何窗口。" }, { "Could not restore the rule snapshot.", "无法恢复规则快照。" }, { "Delete this rule snapshot? Current rules and open windows are not changed.", "删除此规则快照？不会更改当前规则或打开的窗口。" },
			{ "Desktop Rules", "桌面规则" }, { "Desktop rules apply across all virtual desktops. Edit the target desktop and matching logic. Regular expressions are useful when window titles change.", "桌面规则适用于全部虚拟桌面。可编辑目标桌面和匹配逻辑；窗口标题会变化时可使用正则表达式。" }, { "New Desktop Rule", "新增桌面规则" }, { "An application name and window name are required.", "必须输入应用程序名称和窗口名称。" },
			{ "Update Desktop Rules", "更新桌面规则" }, { "Manage Desktop Rules", "管理桌面规则" }, { "Apply Desktop Rules", "应用桌面规则" }, { "No desktop rule changes are needed.", "没有需要更新的桌面规则。" }, { "Review Desktop Rule Changes", "确认桌面规则变更" }, { "Review {0} new and {1} changed desktop rules before saving.", "保存前请确认：将新增 {0} 条、修改 {1} 条桌面规则。" }, { "Change", "变更" }, { "Desktop", "桌面" }, { "Save Desktop Rules", "保存桌面规则" },
			{ "All eligible windows are already locked.", "所有符合条件的窗口都已锁定。" }, { "Review Lock Rules", "确认锁定规则" }, { "Review {0} lock rules that will be added.", "请确认将新增的 {0} 条锁定规则。" }, { "Add Lock Rules", "新增锁定规则" },
			{ "No reliably matching open window was found.", "未找到可靠匹配的打开窗口。" }, { "More than one open window matches this rule.", "此规则匹配了多个打开窗口。" }, { "The window is already on its target desktop.", "窗口已在目标桌面。" }, { "The window can be moved to its target desktop.", "窗口可移动到目标桌面。" }, { "The window closed before it could be moved.", "窗口在移动前已关闭。" }, { "The saved window-title regular expression is invalid.", "保存的窗口标题正则表达式无效。" }, { "The saved window-title regular expression took too long to evaluate.", "保存的窗口标题正则表达式匹配超时。" }, { "Current rules retained when restored", "恢复时保留当前规则" }, { "Desktop ", "桌面 " }, { " [regular expression]", " [正则表达式]" },
			{ "Exported", "导出时间" }, { "Virtual desktops", "虚拟桌面" }, { "Snapshots", "快照" }, { "Configuration backup exported.", "配置备份已导出。" }, { "Could not export the configuration backup.", "无法导出配置备份。" }, { "Could not read the configuration backup.", "无法读取配置备份。" }, { "This replaces saved settings, cleanup rules, desktop rules, and rule snapshots. Open windows will not be moved.", "这会替换已保存的设置、清理规则、桌面规则和规则快照。不会移动打开的窗口。" }, { "This older backup has no cleanup-rule history. Current cleanup rules will be retained.", "此旧版备份没有清理规则历史，将保留当前清理规则。" }, { "Configuration backup imported.", "配置备份已导入。" }, { "Legacy snapshots were imported. Current cleanup rules were retained.", "已导入旧版快照，并保留当前清理规则。" }, { "Could not import the configuration backup.", "无法导入配置备份。" },
