...
namespace WindowsVirtualDesktopHelper.Util {
	public sealed class ApplicationWindow {
		...
		internal ApplicationWindow(IntPtr handle, int processId, string processName, string title) {
			Handle = handle;
			ProcessId = processId;
	...
	public static class WindowEnumerator {
		...
		private static bool TryGetApplicationWindow(IntPtr hWnd, out ApplicationWindow window) {
			...
			window = new ApplicationWindow(hWnd, (int)processId, processName, GetTitle(hWnd));
			return true;
		}
